      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-16 z-40 bg-[#0D0D0D]/98 backdrop-blur-xl border-b border-white/10 md:hidden"
          >
                ...
                {navItems.map((item) => (
                  <li key={item.href}>
                    <Link
                      ...
                      className="block px-4 py-3 rounded-lg text-sm font-medium text-white/60
                                 hover:text-white hover:bg-white/10 transition-all duration-200"
                    >
                      {item.label}
                    </Link>
